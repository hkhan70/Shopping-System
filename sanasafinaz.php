	...
	<section>
		<div class="container">
			<div class="row">
			 ...
			 <?php 
			$html = file_get_html('https://www.sanasafinaz.com/pk/new-arrivals.html');
			...
			foreach($html->find('li[class=item product product-item]') as $element) 
             {  
                   ...
                   $price=$html->find('span[class=price]',$i)->plaintext;
                    ...
                    echo "<a class='order' href='sanasafinaz.php?order_name=". $order ." & order_price=". $price ." > <span class='order'>ORDER NOW</span> </a>"; 
                                                 ...
                                                 if(mysqli_query($conn, $sql))
                                                  {
                                                    ...
                                                    <script language="JavaScript">
                                                        //alert('Order Placed');
                                                      document.location='./sanasafinaz.php';
                                                    </script>
                                                    <?php
                                                  } 
                                                  else
